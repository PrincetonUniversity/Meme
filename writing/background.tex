...
\begin{itemize}
  ...
  \item \textbf{Wildcard Matching:} $S \in \{0,1,*\}^{W_{field}}$ is any ternary string. $M(P) = true$ if, for every $0 \le i < W_{field}$, either the $i^{th}$ character of $S$ is $*$, or the $i^{th}$ character of $S$ matches the $i^{th}$ character of $P[field]$. \jrex{The text doesn't mention rule priorities!}
\end{itemize}
